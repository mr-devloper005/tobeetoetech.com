            ...
            <div className={`p-7 sm:p-8 ${tone.panel}`}>
              ...
              <form className="mt-6 grid gap-4">
                <input
                  className={
                    isDirectory
                      ? 'h-12 rounded-2xl border border-[#1A2B6D]/12 bg-[#f6f8fc] px-4 text-sm text-[#0f1a45] outline-none ring-[#F06529]/25 placeholder:text-slate-400 focus:ring-2'
                      : 'h-12 rounded-2xl border border-current/15 bg-transparent px-4 text-sm outline-none focus:ring-2 focus:ring-current/20'
                  }
                ...
                <input
                  ...
                  placeholder="Topic (billing, safety, partnership…)"
                />
                <textarea
                  className={
                    isDirectory
                      ? 'min-h-[180px] rounded-2xl border border-[#1A2B6D]/12 bg-[#f6f8fc] px-4 py-3 text-sm text-[#0f1a45] outline-none ring-[#F06529]/25 placeholder:text-slate-400 focus:ring-2'
                      : 'min-h-[180px] rounded-2xl border border-current/15 bg-transparent px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-current/20'
                  }
